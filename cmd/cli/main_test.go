...
func TestBootstrapLoadsSavedConfigBeforeStartingCLI(t *testing.T) {
	...
	app, err := bootstrap(core.Services{Platform: platform, ConfigStore: store})
	if err != nil {
...
func TestBootstrapFindsSteamPathWhenConfigMissing(t *testing.T) {
	store := core.NewConfigStore(t.TempDir())
